...
CREATE TABLE transacciones(operacion TEXT, cod_serv INTEGER, tipo INTEGER, compr BIGINT, monto BIGINT, dig_verif INTEGER, prefijo INTEGER, numero INTEGER, medidor BIGINT, abonado BIGINT, transaccion INTEGER, fecha_hora BIGINT, usuario TEXT, vencimiento BIGINT);
